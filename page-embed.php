...
.embed {
  ...
  .embed-content.small_card {
    font-size: 75%;
  }
  .embed-content.small_card .copy {
  ...
  .gh-report .location-name {
    font-size: 24px!important;
    margin-top: 8px;
    
  }
  .gh-report .likelihood {
  ...
  .embed-content.small_card .location-name {
    display: none!important;
  }
  .gh-report .likelihood {
    font-size: 1em!important;
  }
  .gh-report .likelihood:before {
    font-size: .8em!important;
  }
  .embed-date {
    font-weight: 100;
  }
  .embed-content.small_card .embed-date {
    float: right;
    font-size: 80%;
    line-height: 150%;
  }
  .embed-content.large_card .embed-date,
  .embed-content.full_width .embed-date {
    opacity: 1;
    font-size: 70%;
    display: block;
  }
  .gh-report.full_width {
    /*margin-bottom: -10px;*/
  }
  .embed-content.full_width .embed-location .location-name {
    margin-top: 0!important;
  }
  .embed-content.full_width .embed-location .gh-report.full_width {
    margin-top: 0;
  }
