...
function build_embed_code() {
    ...
    $html = '<iframe id="greenhead-report" class="'.$size.'" src="'.trailingslashit(get_bloginfo('url')).'iframe/?embed-location='.urlencode(implode(',',$locations)).'&size='.$size.'" width="'.$width.'" height="'.$height.'" style="border: none;"></iframe>'; //&fields='.urlencode(implode(',',$fields)).'
